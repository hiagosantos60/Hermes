document.addEventListener('DOMContentLoaded', () => {
    ...
    function displayTransferenciaDetails(item) {
        productInfoDetails.innerHTML = `
            ...
            <div class="product-detail-item"><strong>Código:</strong> <span>${item.codigo || ''}</span></div>
    ...
    function displayPhaseoutDetails(item) {
        phaseoutInfoDetails.innerHTML = `
            ...
            <div class="phaseout-detail-item"><strong>Substituto Indicação:</strong> <span>${item.substituto_indicacao || ''}</span></div>
    ...
    openTransferModalBtn.addEventListener('click', () => {
        ...
        searchInput.placeholder = 'Digite o nome, código ou segmento...';
        searchInput.value = '';
